...
function Footer() {
    ...
    return (
        <>
            <footer className='bg-tert text-white pt-[151px] pb-[100px] px-[190px]'>
                <div className="font-semibold text-4xl text-left tracking-normal self-end">Murals.</div>
                <div>
                {data.map(d=><Clink {...d} key={d.label}/>)}
                </div>
                <div>
                    <h4>Contact</h4>
                ...
                <div className='font-semibold text-xl leading-7 text-left tracking-normal font-outfit h-[100px]'>
            ...
            <div className='pb-[11px]' style={{background:'linear-gradient(278.71deg, #ABD9D9 -20.32%, #5151C6 103.51%)'}}></div>
        </>
    )
}
